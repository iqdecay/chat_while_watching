...
import c2w.protocol.messenger_tcp as messenger
...
class c2wTcpChatClientProtocol(Protocol):
    ...
    def __init__(self, clientProxy, serverAddress, serverPort):
        ...
        print("type de self.host_port init : ",type(self.host_port),self.host_port)
        self.clientProxy = clientProxy
        self.exchange = messenger.Client(self.clientProxy, Protocol.transport, self.host_port)
        self.userName = str()
    ...
    def sendLoginRequestOIE(self, userName):
        ...
        self.exchange.transport = self.transport
        self.exchange.transport_not_initialize = False
    ...
    def sendJoinRoomRequestOIE(self, roomName):
        ...
        if roomName == ROOM.MAIN_ROOM :
            self.exchange.send_quit_movie("Mathis > Vitor", self.host_port)

        else :
            self.exchange.send_movie_selection(roomName, self.host_port) # roomName ou moovie_title ? /_\ WARNING /_\ 
    ...
    def sendLeaveSystemRequestOIE(self):
        ...
        """
        self.exchange.send_quit_app("Mathis > Vitor", self.host_port)
        pass
    ...
    def dataReceived(self, data):
        ...
        connection.
        """
        self.exchange.data_concatenate(data)
