...
class c2wTcpChatServerProtocol(Protocol):
    ...
    def __init__(self, serverProxy, clientAddress, clientPort):
        ...
        print("transport  init : ",type(Protocol))
        self.exchange = messenger.Server(self.serverProxy, Protocol.transport, self.host_port)
    ...
    def dataReceived(self, data):
        ...
        connection.
        """
        if self.exchange.transport_not_initialize :
